  ...
  return (
    <div className="mt-8 flex flex-col items-center lg:items-start gap-5">
      ...
      <div className="grid py-2 grid-cols-2 gap-x-8 gap-y-6">
        ...
        {/* GitHub */}
        <a
          href="https://github.com/UmerMalik298"
          target="_blank"
          ...
          <div className="relative w-12 h-12 p-2 rounded-lg
            ...
            >
              <path 
                ...
                className="fill-white transition-colors duration-300 group-hover:fill-[#7ed957] "
              />
            </svg>
...
>
  ...
  <div
    className="absolute -inset-3 rounded-xl
               bg-linear-to-br from-[#7ed957]/0 to-[#7ed957]/0
               transition-all duration-500
               group-hover:from-[#7ed957]/5
               group-hover:to-[#7ed957]/10"
  />

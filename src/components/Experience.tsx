...
EasyKaam | Islamabad, Pakistan
          </p>

          <p className="text-gray-400 leading-relaxed transition-colors duration-300 group-hover:text-gray-200">
           It is an on-site project focused on home and maintenance services.
I worked as a UI/UX Designer, Frontend React Developer, and Project Manager.
Designed the complete product experience and developed the admin panel using React, while managing the project workflow and team coordination.
          </p>
        </div>
      </div>
...
Pakistan
          ...
          <p className="text-gray-400 leading-relaxed transition-colors duration-300 group-hover:text-gray-200">
           Create Static Websites with HTML, css, React, etc
          </p>
        </div>
      </div>
